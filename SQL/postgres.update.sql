...
-- Addition of google contacts
--
-- Sequence "google_contact_ids"
-- Name: google_contact_ids; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE google_contact_ids
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
CREATE TABLE google_contacts (
    contact_id integer DEFAULT nextval('google_contact_ids'::text) PRIMARY KEY,
