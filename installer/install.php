...
<center>
<div id="rounded"><h1><center>Please Wait...</h1>
<br>
...
$rcmail_config['log_driver'] = '<?php echo $_POST["logdriver"] ?>';
...
$rcmail_config['syslog_id'] = '<?php echo $_POST["syslogid"] ?>';

// Syslog facility to use, if using the 'syslog' log driver.
// For possible values see installer or http://php.net/manual/en/function.openlog.php
$rcmail_config['syslog_facility'] = '<?php echo $_POST["syslogfacility"] ?>';

// use this folder to store log files (must be writeable for apache user)
// This is used by the 'file' log driver.
$rcmail_config['log_dir'] = '<?php echo $_POST["logdir"] ?>';

// use this folder to store temp files (must be writeable for apache user)
$rcmail_config['temp_dir'] = '<?php echo $_POST["tempdir"] ?>';
...
$rcmail_config['enable_caching'] = '<?php if (isset ($_POST['enablecaching'])) { echo "true"; } else { echo "false" ; } ?>';
...
$rcmail_config['ip_check'] = '<?php if (isset ($_POST['ipcheck'])) { echo "true"; } else { echo "false" ; } ?>';
...
$rcmail_config['des_key'] = '<?php echo $_POST["deskey"] ?>';
...
$rcmail_config['product_name'] = '<?php echo $_POST["productname"] ?>';
...
$rcmail_config['enable_spellcheck'] = '<?php if (isset ($_POST['enablespellcheck'])) { echo "true"; } else { echo "false" ; } ?>';

// Set the spell checking engine. 'googie' is the default. 'pspell' is also available,
// but requires the Pspell extensions. When using Nox Spell Server, also set 'googie' here.
$rcmail_config['spellcheck_engine'] = '<?php echo $_POST["spellcheckengine"] ?>';
...
$rcmail_config['identities_level'] = <?php echo $_POST["identitieslevel"] ?>';
...
$rcmail_config['db_dsnw'] = 'mysql://mail:mail@localhost/mail';
