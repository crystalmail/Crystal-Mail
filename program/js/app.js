  ...
  this.init = function()
  {
    ...
    switch (this.task) {
      ...
      case 'addressbook':
        ...
        if (this.env.cid)
          this.enable_command('abooknav', 'show', 'edit', true);

        if ((this.env.action=='add' || this.env.action=='edit') && this.gui_objects.editform)
          this.enable_command('abooknav', 'save', true);
        else
...
//    this.env.messages[uid] = rows[uid];
  ...
  this.upload_file = function(form)
  {
    ...
    if (send) {
      ...
      $(fr).bind('load', {ts:ts}, function(e) {
        ...
        if (!String(content).match(/add2attachment/) && (!bw.opera || (cmail.env.uploadframe && cmail.env.uploadframe == e.data.ts))) {
  ...
  this.add_contact_group = function()
  {
    ...
    if (!this.name_input) {
      ...
      this.name_input.onkeypress = function(e){ return cmail.add_input_keypress(e); };
  ...
  this.insert_contact_group = function(prop)
  {
    ...
    var link = $('<a>').attr('href', '#')
      .bind('click', function() { return cmail.command('listgroup', prop.id, this);})
      .html(prop.name);
  ...
  this.rename_folder = function(id)
  {
    ...
    if (id && this.env.subscriptionrows[id] && (row = document.getElementById(id))) {
      ...
      this.name_input.onkeypress = function(e){ cmail.name_input_keypress(e); };
    ...
    for (n=0; thead && n<this.env.coltypes.length; n++) {
      ...
      if ((cell = thead.rows[0].cells[n+1]) && (col=='from' || col=='to')) {
        ...
        if (cell.firstChild && cell.firstChild.tagName.toLowerCase()=='a') {
          ...
          cell.firstChild.onclick = function(){ return cmail.command('sort', this.__col, this); };
